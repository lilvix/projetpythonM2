...
liste_phrase_menu=["Pour voir les langues disponibles : entrer 4",
                   ...
                   "langues disponibles :",
                   "choix incorecte",
                   "combien de mot voulez vous chercher : ",
...
liste_mot_simple=["tests","tests2"]

liste_mot_moyen=["testm","testm2"]

liste_mot_difficile=["testd","testd2"]
...
def menu():
    ...
    while (choix != "7"):
        ...
        choix = input(liste_phrase_menu[4] + " ")
