...
liste_phrase_special=["La langue proposé à la traduction est le francais : pour la changer entrer 1",
                      ...
                      "Le jeu est actuellement en francais : pour la changer entrer 3",
...
liste_phrase_jeu=["donner la traduction de ",
                  ...
                  " vous avez eu ",
                  "et",
                  "essayer d'améliorer votre socre"
                  ]
...
def traduction_phrase_du_jeu():
    ...
    if (langue_jeu!='fr'):
        ...
        liste_phrase_special[4] = str(trad_menu(liste_phrase_special[5]))
...
def score_phrase(propostion,tab_phrase_split):
    ...
    if (score<0):
        score=0
    print(str(trad_menu("votre score sur cette phrase est de "+str(score)+" % de réussite")))
    return score
...
def partie(nbmot):
        ...
        while (nbechec >= 0 and nbechec < 3):
            ...
            if mode_jeu=="mot":
                ...
                if (nbechec == 3):
                    ...
                    print(liste_phrase_jeu[6] + " ")
                    motactuel = motactuel + 1
                    print(str(trad_menu("votre meilleurs socre pour cette phrase était de "+str(+max_score_essaie))))
    ...
    if (mode_jeu=="mot"):
        ...
        print(str(trad_menu("votre score moyen pour cette partie est de "+str(score_total/len(tab_score))+ "% de réussite")))
    menu()
