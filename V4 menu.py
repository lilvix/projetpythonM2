...
def menu():
    ...
    while (choix != "3"):
        ...
        print("Pour commencer une partie : entrer 3")
        print("Pour voir les langues disponibles : entrer 4")
        print("Il y a actuelement "+str(nbmot)+" mots a trouver : pour modifier le nombre de mot à trouver entrer 5")
